...
{
    public class InvestmentInstitutionSpecification : BaseSpecification<InvestmentInstitution>
    {

        public InvestmentInstitutionSpecification(InvestmentInstitutionSpecParams parrams)
           : base(x =>
        ...
        public InvestmentInstitutionSpecification(int id)

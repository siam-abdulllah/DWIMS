...
const portalRoutes: Routes = [
  {
    ...
    children: [
        ...
        {path: 'rptCampSummary', component: RptCampaignSummaryComponent, canActivate: [SuperAdminRoleGuard]},
        ...
        {path: 'bgtEmpDisburse', component: BgtEmpDisburseComponent,canActivate: [SuperAdminRoleGuard] },

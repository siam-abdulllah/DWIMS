        ...
        public async Task<ActionResult<InvestmentRecvDto>> InsertInvestmentRecv(InvestmentRecvDto investmentRecvDto)
        {
            try
            {
                ...
                var invRec = new InvestmentRecv
                {
                    ...
                    PayRefNo = investmentRecvDto.PayRefNo,
